...
struct IgnoreCodingTests {
    @Test("misuse On Uninitialized Variable")
    ...
    @Test("misuse With Invalid Combination")
    ...
    @Suite("Ignore Coding - Decoding Encoding Ignore")
    struct DecodingEncodingIgnore {
        ...
        @Test("ignore Coding From J S O N")
    ...
    @Suite("Ignore Coding - Enum Decoding Encoding Ignore")
    ...
    @Suite("Ignore Coding - Decoding Ignore")
    ...
    @Suite("Ignore Coding - Enum Decoding Ignore")
    ...
    @Suite("Ignore Coding - Encoding Ignore")
    ...
    @Suite("Ignore Coding - Encoding Ignore With Condition")
    ...
    @Suite("Ignore Coding - Enum Encoding Ignore")
    ...
    @Suite("Ignore Coding - Enum Encoding Ignore With Condition")
    ...
    @Suite("Ignore Coding - Enum Encoding Ignore With Condition Combined")
    ...
    @Suite("Ignore Coding - Combination With Other Macros")
    ...
    @Suite("Ignore Coding - Class Combination With Other Macros")
    ...
    @Suite("Ignore Coding - Enum Combination With Other Macros")
    ...
    @Suite("Ignore Coding - Encoding Ignore With Based On Condition")
    ...
    @Suite("Ignore Coding - Enum Encoding Ignore With Based On Condition")
