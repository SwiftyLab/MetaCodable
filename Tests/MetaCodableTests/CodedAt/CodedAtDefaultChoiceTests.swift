...
@Suite("Coded At Default Choice Tests")
struct CodedAtDefaultChoiceTests {
    @Suite("Coded At Default Choice - With No Path")
    struct WithNoPath {
        @Codable
        @MemberInit
        struct SomeCodable {
    ...
    @Suite("Coded At Default Choice - With No Path On Optional Type")
    struct WithNoPathOnOptionalType {
        ...
        @Suite("Coded At Default Choice - Force Unwrap")
        struct ForceUnwrap {
            @Codable
            @MemberInit
            struct SomeCodable {
    ...
    @Suite("Coded At Default Choice - With Single Path")
    ...
    @Suite("Coded At Default Choice - With Single Path On Optional Type")
    ...
    @Suite("Coded At Default Choice - With Nested Path")
    ...
    @Suite("Coded At Default Choice - With Nested Path On Optional Type")
    ...
    @Suite("Coded At Default Choice - With Nested Path On Multi Optional Types")
    ...
    @Suite("Coded At Default Choice - With Nested Path On Mixed Types")
    ...
    @Suite("Coded At Default Choice - Class With Nested Path On Mixed Types")
