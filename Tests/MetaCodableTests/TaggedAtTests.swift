...
final class TaggedAtTests: XCTestCase {
    ...
    func testMisuseOnNonEnumDeclaration() throws {
        assertMacroExpansion(
            ...
            diagnostics: [
                .init(
                    id: TaggedAt.misuseID,
                    message:
                        "@TaggedAt only applicable to enum declarations",
                    line: 1, column: 1,
                    fixIts: [
                        .init(message: "Remove @TaggedAt attribute")
                    ]
                ),
                .init(
                    id: TaggedAt.misuseID,
                    message:
                        "@TaggedAt must be used in combination with @Codable",
                    line: 1, column: 1,
                    fixIts: [
                        .init(message: "Remove @TaggedAt attribute")
                    ]
        ...
        assertMacroExpansion(
            ...
            diagnostics: [
                .init(
                    id: TaggedAt.misuseID,
                    message:
                        "@TaggedAt can only be applied once per declaration",
                    line: 2, column: 1,
                    fixIts: [
                        .init(message: "Remove @TaggedAt attribute")
                    ]
    ...
    func testWithCodedAtWithoutArgWithoutExplicitType() throws {
        assertMacroExpansion(
            """
            @Codable
            @TaggedAt("type")
    ...
    func testWithCodedAtWithoutExplicitType() throws {
        assertMacroExpansion(
            """
            @Codable
            @TaggedAt("type")
    ...
    func testWithCodedAtWithExplicitType() throws {
        assertMacroExpansion(
            """
            @Codable
            @TaggedAt("type")
    ...
    func testWithCodedAtWithHelperExpression() throws {
        assertMacroExpansion(
            """
            @Codable
            @TaggedAt("type")
