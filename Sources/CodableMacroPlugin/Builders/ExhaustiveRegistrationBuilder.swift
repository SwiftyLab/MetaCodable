/// A registration builder that combines one optional builder with
/// a fallback builder.
///
...
where Input: Variable, Output: Variable {
    ...
    ///
    /// The builder action is initialized with optional builder's action
    /// if provided, otherwise fallback builder's action is used.
    ///
    /// - Parameters:
