...
package struct EncodedAt: PropertyAttribute {
    ...
    ///     attribute.
    ///   * This attribute must be combined with `DecodedAt`
    ///     attribute.
    /// * else:
        ...
        AggregatedDiagnosticProducer {
            ...
            `if`(
                ...
                AggregatedDiagnosticProducer {
                    ...
                    mustBeCombined(with: DecodedAt.self)
                },
...
extension EncodedAt: KeyPathProvider {
    ...
    /// for encoding, but not for decoding.
    ///
